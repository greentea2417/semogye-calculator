      ...
      <div className="mb-8">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-2xl border border-gray-200 bg-white px-4 py-3 pr-10 text-sm shadow-sm outline-none transition placeholder:text-gray-400 focus:border-green-300 focus:ring-4 focus:ring-green-100"
          />
          {query ? (
            <button
              type="button"
