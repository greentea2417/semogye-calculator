        ...
        <div className="flex flex-col gap-3">
          ...
          <Link href="/life/kbm" className="block p-7 bg-white rounded-[32px] border border-gray-50 shadow-sm hover:shadow-md hover:bg-gray-50 transition-all group">
            <div className="flex flex-col items-center text-center">
              <h3 className="font-bold text-gray-900 text-lg not-italic">
                키빼몸 · 미용 몸무게
              </h3>
              <p className="text-gray-400 text-sm mt-1.5 not-italic">
                나의 키에 맞는 가장 예쁘고 건강한 체중 확인
              </p>
            </div>
          </Link>
