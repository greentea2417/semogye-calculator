...
export default function Withholding33Page() {
  ...
  return (
    <CalculatorLayout tone="business" title="원천세 3.3% 계산기" subtitle="프리랜서·사업소득 지급액에서 3.3%를 공제한 실수령액을 계산합니다." intro="소득세 3% + 지방소득세 0.3%를 기준으로 계산합니다. 3.3%가 최종 세금이 아니라 선납이라는 점까지 함께 확인할 수 있습니다." faqTitle="원천세 3.3% 계산기 자주 묻는 질문" faqItems={[
