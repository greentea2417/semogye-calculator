...
export default function VatPreNoticePage() {
  ...
  return <CalculatorLayout title="부가세 예정고지 계산기" subtitle="직전 납부세액을 기준으로 부가세 예정고지세액을 계산합니다." intro="부가세 예정고지는 보통 직전 과세기간 납부세액의 1/2로 계산합니다. 개인 일반과세자에게 주로 적용되며, 예정고지세액과 고지 제외 기준도 함께 확인할 수 있습니다." faqTitle="부가세 예정고지 계산기 자주 묻는 질문" faqItems={[{ q: "Q. 계산식은 무엇인가요?", a: "A. 예정고지세액 = 직전 납부세액 × 1/2 입니다." }, { q: "Q. 10만원 미만이면 어떻게 되나요?", a: "A. 예정고지세액이 10만원 미만인 경우 0원으로 처리했습니다." }, { q: "Q. 0원이나 빈칸도 되나요?", a: "A. 네. 빈칸은 0으로 처리합니다." }, { q: "Q. CSV에는 무엇이 들어가나요?", a: "A. 입력한 직전 납부세액과 계산된 예정고지세액이 들어갑니다." }]} result={<ResultPanel title="부가세 예정고지 계산 결과" lines={lines} total={{ label: "예정고지세액", value: `${result.notice.toLocaleString()}원` }} note="* 예정고지 대상 여부와 신고대체 가능 여부는 관할 세무서 안내를 확인하세요." />} guide={<BottomActions onShare={onShare} onExcelDownload={onCsvDownload} />} article={
      <CalculatorArticle
        sections={[
          {
            heading: "부가세 예정고지란?",
