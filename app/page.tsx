  ...
  return (
    <main className="max-w-xl mx-auto px-5 py-16 space-y-16">
      <section className="space-y-2">
        ...
        {/* 틸트 제거 완료 */}
        <p className="text-sm text-gray-400 font-medium">계산하고 싶은 모든 것</p>
      </section>
      ...
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <Link href="/business" className="group block bg-white border border-gray-100 p-7 rounded-[32px] hover:border-blue-500 transition-all duration-300 shadow-sm shadow-gray-200/20 hover:shadow-blue-500/5">
            <div className="flex justify-between items-center">
              <div>
                <h3 className="font-bold text-lg text-gray-900 mb-0.5">금융·정산</h3>
                <p className="text-xs text-gray-400 font-medium">월급, 시급부터 사업 정산까지</p>
              </div>
          ...
          <Link href="/life" className="group block bg-white border border-gray-100 p-7 rounded-[32px] hover:border-blue-500 transition-all duration-300 shadow-sm shadow-blue-500/5">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-xs text-gray-400 font-medium">학점, 키빼몸 등 일상 지표</p>
              </div>
              <span className="text-xl text-gray-200 group-hover:text-blue-500 transition-colors transform group-hover:translate-x-1 duration-300">→</span>
            </div>
          </Link>
